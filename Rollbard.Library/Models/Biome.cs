...
namespace Rollbard.Library.Models
{
    public class Biome(string text, params string[] names)
    {
        ...
        public static Biome Desert = new(nameof(Desert), "Desert", "Dunes");
        ...
        public static Biome Swampland = new(nameof(Swampland), "Bog", "Marsh", "Marshland", "Marshlands", "Swamp", "Swampland", "Swamplands");
        public static Biome Tundra = new(nameof(Tundra), "Forest", "Snowfield", "Snowfields", "Tundra");
